...
function App() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-b from-[#1B2735] to-[#090A0F] relative overflow-hidden">
      ...
      <div className="min-h-[100dvh] flex flex-col items-center justify-center text-center relative pb-16">
